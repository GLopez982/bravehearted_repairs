...
export default function NavBar(){
    return(
        <nav className="bg-[#E77014] border-b-2 border-black w-full h-auto lg:h-[165px] lg:px-10 flex flex-1">
            ...
            <div className='flex flex-col justify-center text-[20px] lg:text-[30px] font-bold focus:text-[#110211] focus:text-shadow-white active:text-shadow-white hover:text-[#110211] hover:text-shadow-lg hover:text-shadow-white '>
                <Image
                    src="/brave-word.png"
